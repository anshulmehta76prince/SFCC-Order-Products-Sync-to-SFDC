...
function OrderToSFDC(parameters, stepExecution) {
    ...
    while (orders.hasNext()) {
        ...
        while(shipments.hasNext()){
            ...
            shipmentData['order_no'] = order.getOrderNo();
            shipmentData['shipment_id'] = Shipment.getID();
            shipmentData['shipment_no'] = Shipment.getShipmentNo();
            shipmentData['shipping_status'] = Shipment.getShippingStatus().toString();
            shipmentData['tracking_number'] = Shipment.getTrackingNumber();
            shipmentData['product_total'] = Shipment.getMerchandizeTotalPrice().toString();
            shipmentData['shipping_total'] = Shipment.getShippingTotalNetPrice().toString();
            shipmentData['tax_total'] = Shipment.getTotalTax().toString();
            shipmentData['shipment_total'] = Shipment.getTotalGrossPrice().toString();


            shipmentsData.push(shipmentData);
        }

        data['shipments'] = shipmentsData;
